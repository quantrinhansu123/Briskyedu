...
exports.onClassDeleteStudentAttendance = exports.onAttendanceRecordDelete = exports.onStudentAttendanceDelete = exports.onStudentAttendanceUpdate = exports.onStudentAttendanceCreate = void 0;
 ...
 */
function calculateExpectedEndDate(remainingSessions, daysPerWeek, startDate) {
 ...
 */
exports.onStudentAttendanceCreate = functions
    .region(REGION)
    .firestore
    ...
    const expectedEndDate = calculateExpectedEndDate(remaining, daysPerWeek, studentData.startDate || data.date);
    // Prepare update data
    const updateData = {
 ...
 * - Sync grade data
 */
exports.onStudentAttendanceUpdate = functions
    .region(REGION)
    .firestore
    .document('studentAttendance/{docId}')
 ...
 */
exports.onStudentAttendanceDelete = functions
    .region(REGION)
    .firestore
    .document('studentAttendance/{docId}')
 ...
 */
exports.onAttendanceRecordDelete = functions
    .region(REGION)
    .firestore
 ...
 * - Delete all related studentAttendance records
 */
exports.onClassDeleteStudentAttendance = functions
    .region(REGION)
    .firestore
    ...
    console.log(`[onClassDeleteStudentAttendance] Class deleted: ${classData === null || classData === void 0 ? void 0 : classData.name} (${classId})`);
...
//# sourceMappingURL=studentAttendanceTriggers.js.map